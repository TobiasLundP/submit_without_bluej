package cs.au.dk;// Version: 2018092501
import java.io.*;
import java.net.*;
import java.util.*;
        ...
        try {
            try(Writer file = new FileWriter(data_filename)) {
                try(PrintWriter out = new PrintWriter(file)) {
                    ...
                    out.println("This file is used when you call cs.au.dk.Submit.submit() with no arguments.");
                }
            }
            submit();
        } catch (IOException e) {
        ...
        for (String fileName : getFilenames()) {
            try(FileReader file = new FileReader(fileName)) {
                ...
                while (true) {
                    ...
                    // to avoid cs.au.dk.Submit.java detecting itself as a task file.
