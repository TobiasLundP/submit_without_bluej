package cs.au.dk.tasks.order;// Version: 2017103102
...
public class RedBlackTree {
    ...
    private Node select(Node x, int rank) {
        // Implement your method to return the key with the given rank
        return x;
    }
    ...
    public int rank(Node x) {
        int rank = 0;
        // Implement your method to return the rank of the given Node.
        return rank;
    }
